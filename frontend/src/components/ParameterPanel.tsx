...
export default function ParameterPanel({ params, onChange, onRun, loading }: Props) {
  return (
    <div style={{
            ...
            <div key={s.key}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                ...
                <div style={{
                  ...
                  {val} <span style={{ fontSize: 10, fontWeight: 400, opacity: 0.7 }}>{s.unit}</span>
                </div>
              </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, fontWeight: 600, color: "#334155", textTransform: "uppercase", letterSpacing: "0.8px", marginBottom: 12 }}>
          Bagaj Akışı
        </div>
        {[
          ...
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            {i < arr.length - 1 && (
              <div style={{
                marginLeft: 13, width: 2, height: 12,
